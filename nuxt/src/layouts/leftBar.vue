    ...
    >
      ...
      <q-item @click.native="$router.push('/')" class="cursor-pointer">
        ...
        <q-item-main>
          ...
          <q-item-tile sublabel>Hírek, újdonságok</q-item-tile>
        </q-item-main>
      ...
      <q-item v-show="$store.getters.isUserAnAdminOrOwner" @click.native="$router.push('/admin')" class="cursor-pointer shadow-1 bg-grey-3">
