<template>
  <q-modal
    v-model="$store.state.showAuthModal"
  >
    <q-tabs padding style="width: 700px; max-width: 100vw;" color="primary" class="shadow-24" glossy align="justify">
      ...
      <q-tab-pane name="Belépés">
        ...
        <q-btn color="warning" class="float-right" icon-right="fa-times" @click="$store.dispatch('toggleAuthModal')" label="Bezárás" />
      </q-tab-pane>
